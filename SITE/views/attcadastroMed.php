...
<body style="overflow-x: hidden; font-family:'Battambang', sans-serif;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link fs-4 px-4" href="/PROJETO-FINAL-CLINICA/SITE/public/med">Início</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fs-4 px-4 active" href="/PROJETO-FINAL-CLINICA/SITE/public/consultarCadastrosM">Cadastros</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container mt-5">
        ...
        <form action="/PROJETO-FINAL-CLINICA/SITE/public/updateCadastroM" method="POST">
            <input type="hidden" name="id" value="<?php echo $medInfo['id']; ?>">
            
            <div class="mb-3">
                <label for="nome" class="form-label">Nome Completo</label>
                <input type="text" name="nome" id="nome" class="form-control" placeholder="Nome completo"
                    value="<?php echo htmlspecialchars($medInfo['nome']); ?>" required>
            </div>

            <div class="mb-3">
                <label for="email" class="form-label">E-mail</label>
                <input type="email" name="email" id="email" class="form-control" placeholder="E-mail"
                    value="<?php echo htmlspecialchars($medInfo['email']); ?>" required>
            </div>

            <div class="mb-3">
                <label for="senha" class="form-label">Senha</label>
                <input type="password" name="senha" id="senha" class="form-control" placeholder="Senha"
                    value="<?php echo htmlspecialchars($medInfo['senha']); ?>" required>
            </div>

            <div class="mb-3">
                <label for="cpf" class="form-label">CPF</label>
                <input type="text" name="cpf" id="cpf" class="form-control" placeholder="CPF"
                    value="<?php echo htmlspecialchars($medInfo['cpf']); ?>" required>
            </div>

            <div class="mb-3">
                <label for="crm" class="form-label">CRM</label>
                <input type="text" name="crm" id="crm" class="form-control" placeholder="CRM"
                    value="<?php echo htmlspecialchars($medInfo['crm']); ?>" required>
            </div>

            <div class="mb-3">
                <label for="rg" class="form-label">RG</label>
                <input type="text" name="rg" id="rg" class="form-control" placeholder="RG"
                    value="<?php echo htmlspecialchars($medInfo['rg']); ?>" required>
            </div>

            <div class="mb-3">
                <label for="nasc" class="form-label">Data de Nascimento</label>
                <input type="date" name="nasc" id="nasc" class="form-control"
                    value="<?php echo htmlspecialchars($medInfo['nasc']); ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="sexo" id="sexo" class="form-select" required>
                    ...
                    <option value="masc" <?php echo ($medInfo['sexo'] === 'masc') ? 'selected' : ''; ?>>Masculino</option>
                    <option value="fem" <?php echo ($medInfo['sexo'] === 'fem') ? 'selected' : ''; ?>>Feminino</option>
                </select>
            </div>
