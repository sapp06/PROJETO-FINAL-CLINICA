                ...
                <tbody>
                    <?php foreach ($adms as $adm): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($med['nasc']); ?></td>
                            <td><?php echo htmlspecialchars($med['cpf']); ?></td>
                            <td><?php echo htmlspecialchars($med['crm']); ?></td>
                            <td><?php echo htmlspecialchars($med['rg']); ?></td>
                            <td><?php echo htmlspecialchars($med['sexo']); ?></td>
                            <td>
                                <a href="/PROJETO-FINAL-CLINICA/SITE/public/updateCadastro/<?php echo $med['id']; ?>" class="btn btn-atualizar">Atualizar</a>
